...
const styles = StyleSheet.create({
  ...
  subtitulo: { fontSize: 14, color: '#A0A0A0', marginTop: 4 },
  cerrarSesion: { 
    color: '#1DB954', 
    fontSize: 14, 
    fontWeight: '600', 
  ...
  descripcion: { fontSize: 15, color: '#fff', marginBottom: 8, lineHeight: 22 },
  direccion: { fontSize: 13, color: '#A0A0A0', marginBottom: 6 },
  cliente: { fontSize: 13, color: '#A0A0A0', marginBottom: 12 },
  btnOferta: { backgroundColor: '#1DB954', padding: 12, borderRadius: 8, alignItems: 'center' },
  btnIniciar: { backgroundColor: '#FFB81C', padding: 12, borderRadius: 8, alignItems: 'center' },
  btnFinalizar: { backgroundColor: '#FF4444', padding: 12, borderRadius: 8, alignItems: 'center' },
  btnTxt: { color: '#000', fontWeight: 'bold', fontSize: 15 },
  esperandoBadge: { padding: 10, alignItems: 'center', backgroundColor: '#rgba(255,184,28,0.12)', borderRadius: 8 },
